...
wms_url = "https://dev-oceanportal.spc.int/thredds/wms/POP/model/regional/bom/forecast/monthly/accesss/seasonal_sst/latest.nc"
...
params = {
    ...
    "request": "GetMap",
    "layers": "sst",
    "styles": "scalar-converge-final/psu-viridis",
    "format": "image/png",
    "transparent": "true",
    "version": "1.1.1",  # WMS version 1.1.1
    "colorscalerange": "0, 32",
    "numcolorbands": "250",
    "time": "2025-04-16T00:00:00Z",  # Specific time for SST data
    "logscale": "false",
...
if response.status_code == 200:
    ...
    # Set title
    plt.title('Sea Surface Temperature (SST) - Pacific Ocean (2025-04-16T00:00:00Z)')
    ...
    legend_params = {
        ...
        "PALETTE": "default",
        "LAYERS": "mn_wav_dir",
        "STYLES": "raster/psu-viridis",
        "COLORSCALERANGE": "0,32",  # Legend scale for wave direction
        "FORMAT": "image/png",
        "TRANSPARENT": "true",
        "WIDTH": "30",
        "HEIGHT": "300"
