    ...
    if outlook:
        ...
        if response.status_code == 200:
            ...
            for i, step in enumerate(steps):
                ...
                plt.text(1.05, (i / position), f'{step:.1f}', transform=plt.gca().transAxes, fontsize=14, color='black', va='center', ha='left')
            ...
            if units != "null":
                ...
                plt.text(-0.08, 0.02, units, transform=plt.gca().transAxes, fontsize=12, color='black', va='bottom', ha='center', rotation=90)
