...
img = m.imshow(img_array, origin='upper')
...
# Add colorbar with your exact preferred styling
cbar = plt.colorbar(sm, cax=ax_legend, extend='both')
...
# If you want to apply the same discrete coloring to your imshow:
#img.set_norm(norm) 
ax_legend.axis('off')
"""
